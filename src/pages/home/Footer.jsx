  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/deepansh.png" alt="Deepansh" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/deepansh.pandey.73"
            ...
            <li>
              <a
                href="https://www.instagram.com/deepansh_kr/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/deepansh-kumar-pandey-644936234/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        ...
        <a
        href="https://mail.google.com/mail/?view=cm&fs=1&to=deepanshkumarpandey@gmail.com"
        target="_blank"
        rel="noopener noreferrer"
        >
    deepanshkumarpandey@gmail.com
        </a>
        </p>
        <div className="footer--social--icon">
          <ul>
